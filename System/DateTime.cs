  ...
  IEquatable<DateTime>
{
  ...
  private const ulong TicksMask = 4611686018427387903 /*0x3FFFFFFFFFFFFFFF*/;
  private const ulong FlagsMask = 13835058055282163712 /*0xC000000000000000*/;
  private const ulong LocalMask = 9223372036854775808 /*0x8000000000000000*/;
  private const long TicksCeiling = 4611686018427387904 /*0x4000000000000000*/;
  private const ulong KindUnspecified = 0;
  private const ulong KindUtc = 4611686018427387904 /*0x4000000000000000*/;
  private const ulong KindLocal = 9223372036854775808 /*0x8000000000000000*/;
  private const ulong KindLocalAmbiguousDst = 13835058055282163712 /*0xC000000000000000*/;
  ...
  {
    this.dateData = ticks >= 0L && ticks <= 3155378975999999999L ? (ulong) ticks : throw new ArgumentOutOfRangeException(nameof (ticks), Environment.GetResourceString("ArgumentOutOfRange_DateTimeBadTicks"));
  }

  private DateTime(ulong dateData) => this.dateData = dateData;
  ...
  internal DateTime(long ticks, DateTimeKind kind, bool isAmbiguousDst)
  {
    if (ticks < 0L || ticks > 3155378975999999999L)
      throw new ArgumentOutOfRangeException(nameof (ticks), Environment.GetResourceString("ArgumentOutOfRange_DateTimeBadTicks"));
    this.dateData = (ulong) (ticks | (isAmbiguousDst ? -4611686018427387904L /*0xC000000000000000*/ : long.MinValue));
  }
    ...
    int millisecond)
  {
    ...
    this.dateData = num >= 0L && num <= 3155378975999999999L ? (ulong) num : throw new ArgumentException(Environment.GetResourceString("Arg_DateTimeRange"));
  }
    ...
    Calendar calendar)
  {
    ...
    this.dateData = num2 >= 0L && num2 <= 3155378975999999999L ? (ulong) num2 : throw new ArgumentException(Environment.GetResourceString("Arg_DateTimeRange"));
    if (num1 != 60)
      return;
    DateTime dateTime = new DateTime(this.dateData);
    if (!DateTime.IsValidTimeWithLeapSeconds(dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, dateTime.Minute, 60, DateTimeKind.Unspecified))
  ...
  internal long InternalTicks => (long) this.dateData & 4611686018427387903L /*0x3FFFFFFFFFFFFFFF*/;

  private ulong InternalKind => this.dateData & 13835058055282163712UL /*0xC000000000000000*/;
  ...
  public DateTime AddMonths(int months)
  {
    ...
    int num2 = year2 >= 1 && year2 <= 9999 ? DateTime.DaysInMonth(year2, month) : throw new ArgumentOutOfRangeException(nameof (months), Environment.GetResourceString("ArgumentOutOfRange_DateArithmetic"));
    if (day > num2)
      day = num2;
  ...
  public int CompareTo(object value)
  {
    if (value == null)
      return 1;
    long num = value is DateTime dateTime ? dateTime.InternalTicks : throw new ArgumentException(Environment.GetResourceString("Arg_MustBeDateTime"));
    long internalTicks = this.InternalTicks;
    if (internalTicks > num)
      return 1;
    return internalTicks < num ? -1 : 0;
  }
  ...
  {
    return value is DateTime dateTime && this.InternalTicks == dateTime.InternalTicks;
  }

  [__DynamicallyInvokable]
  public bool Equals(DateTime value) => this.InternalTicks == value.InternalTicks;

  [__DynamicallyInvokable]
  public static bool Equals(DateTime t1, DateTime t2) => t1.InternalTicks == t2.InternalTicks;
  ...
  public static DateTime FromBinary(long dateData)
  {
    ...
    long ticks1 = dateData & 4611686018427387903L /*0x3FFFFFFFFFFFFFFF*/;
    if (ticks1 > 4611685154427387904L)
      ticks1 -= 4611686018427387904L /*0x4000000000000000*/;
    ...
    return ticks3 >= 0L && ticks3 <= 3155378975999999999L ? new DateTime(ticks3, DateTimeKind.Local, isAmbiguousLocalDst) : throw new ArgumentException(Environment.GetResourceString("Argument_DateTimeBadBinaryData"), nameof (dateData));
  }

  internal static DateTime FromBinaryRaw(long dateData)
  {
    long num = dateData & 4611686018427387903L /*0x3FFFFFFFFFFFFFFF*/;
    if (num < 0L || num > 3155378975999999999L)
  ...
  public static DateTime FromFileTimeUtc(long fileTime)
  {
    ...
    return DateTime.s_isLeapSecondsSupportedSystem ? DateTime.InternalFromFileTime(fileTime) : new DateTime(fileTime + 504911232000000000L, DateTimeKind.Utc);
  }
  ...
  public long ToBinary()
  {
    ...
    if (num < 0L)
      num = 4611686018427387904L /*0x4000000000000000*/ + num;
    return num | long.MinValue;
  }

  internal long ToBinaryRaw() => (long) this.dateData;
  ...
  public int Day
  {
    [__DynamicallyInvokable] get => this.GetDatePart(3);
  }

  [__DynamicallyInvokable]
  public DayOfWeek DayOfWeek
  {
    [__DynamicallyInvokable] get => (DayOfWeek) ((this.InternalTicks / 864000000000L + 1L) % 7L);
  }

  [__DynamicallyInvokable]
  public int DayOfYear
  {
    [__DynamicallyInvokable] get => this.GetDatePart(1);
  }
  ...
  {
    long internalTicks = this.InternalTicks;
    return (int) internalTicks ^ (int) (internalTicks >> 32 /*0x20*/);
  }

  [__DynamicallyInvokable]
  public int Hour
  {
    [__DynamicallyInvokable] get => (int) (this.InternalTicks / 36000000000L % 24L);
  }

  internal bool IsAmbiguousDaylightSavingTime()
  {
    return this.InternalKind == 13835058055282163712UL /*0xC000000000000000*/;
  }
  ...
  public DateTimeKind Kind
  {
    [__DynamicallyInvokable] get
    {
      switch (this.InternalKind)
      {
        ...
        case 4611686018427387904 /*0x4000000000000000*/:
  ...
  {
    [__DynamicallyInvokable] get => (int) (this.InternalTicks / 10000L % 1000L);
  }

  [__DynamicallyInvokable]
  public int Minute
  {
    [__DynamicallyInvokable] get => (int) (this.InternalTicks / 600000000L % 60L);
  }

  [__DynamicallyInvokable]
  public int Month
  {
    [__DynamicallyInvokable] get => this.GetDatePart(2);
  }
  ...
  public static DateTime Now
  {
    [__DynamicallyInvokable] get
    {
      ...
      return ticks2 < 0L ? new DateTime(0L, DateTimeKind.Local) : new DateTime(ticks2, DateTimeKind.Local, isAmbiguousLocalDst);
    }
  }
  ...
  public static DateTime UtcNow
  {
    [SecuritySafeCritical, __DynamicallyInvokable] get
    {
      if (!DateTime.s_isLeapSecondsSupportedSystem)
        return new DateTime((ulong) (DateTime.GetSystemTimeAsFileTime() + 504911232000000000L | 4611686018427387904L /*0x4000000000000000*/));
  ...
  internal static bool SystemSupportLeapSeconds() => DateTime.IsLeapSecondsSupportedSystem();
  ...
  {
    return new DateTime((ulong) (DateTime.DateToTicks((int) time.wYear, (int) time.wMonth, (int) time.wDay) + DateTime.TimeToTicks((int) time.wHour, (int) time.wMinute, (int) time.wSecond) + (long) time.wMillisecond * 10000L + time.hundredNanoSecond | 4611686018427387904L /*0x4000000000000000*/));
  }
    ...
    DateTimeKind kind)
  {
    ...
    return DateTime.ValidateSystemTime(ref time, true) || DateTime.ValidateSystemTime(ref time, false);
  }

  [__DynamicallyInvokable]
  public int Second
  {
    [__DynamicallyInvokable] get => (int) (this.InternalTicks / 10000000L % 60L);
  }

  [__DynamicallyInvokable]
  public long Ticks
  {
    [__DynamicallyInvokable] get => this.InternalTicks;
  }

  [__DynamicallyInvokable]
  public TimeSpan TimeOfDay
  {
    [__DynamicallyInvokable] get => new TimeSpan(this.InternalTicks % 864000000000L);
  }

  [__DynamicallyInvokable]
  public static DateTime Today
  {
    [__DynamicallyInvokable] get => DateTime.Now.Date;
  }

  [__DynamicallyInvokable]
  public int Year
  {
    [__DynamicallyInvokable] get => this.GetDatePart(0);
  }
  ...
  [__DynamicallyInvokable]
  public double ToOADate() => DateTime.TicksToOADate(this.InternalTicks);
  ...
  public long ToFileTimeUtc()
  {
    ...
    return num >= 0L ? num : throw new ArgumentOutOfRangeException((string) null, Environment.GetResourceString("ArgumentOutOfRange_FileTimeInvalid"));
  }

  [__DynamicallyInvokable]
  public DateTime ToLocalTime() => this.ToLocalTime(false);
