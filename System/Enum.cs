...
public abstract class Enum : ValueType, IComparable, IFormattable, IConvertible
{
  ...
  {
    if (!(enumType.GenericCache is Enum.ValuesAndNames cachedValuesAndNames) || getNames && cachedValuesAndNames.Names == null)
    {
      ulong[] o1 = (ulong[]) null;
      ...
      cachedValuesAndNames = new Enum.ValuesAndNames(o1, o2);
      enumType.GenericCache = (object) cachedValuesAndNames;
    }
    return cachedValuesAndNames;
  }
  ...
  private static string InternalFlagsFormat(RuntimeType eT, object value)
  {
    ...
    return values.Length != 0 && values[0] == 0UL ? names[0] : "0";
  }
  ...
  private static bool TryParseEnum(
    ...
    string value,
    bool ignoreCase,
    ref Enum.EnumResult parseResult)
  {
    RuntimeType enumType1 = !(enumType == (Type) null) ? enumType as RuntimeType : throw new ArgumentNullException(nameof (enumType));
  ...
  {
    return !(enumType == (Type) null) ? enumType.GetEnumUnderlyingType() : throw new ArgumentNullException(nameof (enumType));
  }
  ...
  {
    return !(enumType == (Type) null) ? enumType.GetEnumValues() : throw new ArgumentNullException(nameof (enumType));
  }
  ...
  {
    return !(enumType == (Type) null) ? enumType.GetEnumNames() : throw new ArgumentNullException(nameof (enumType));
  }
  ...
  {
    TypeCode typeCode = value != null ? Convert.GetTypeCode(value) : throw new ArgumentNullException(nameof (value));
  ...
  {
    return !(enumType == (Type) null) ? enumType.IsEnumDefined(value) : throw new ArgumentNullException(nameof (enumType));
  }
  ...
  public override unsafe int GetHashCode()
  {
    fixed (byte* numPtr = &JitHelpers.GetPinningHelper((object) this).m_data)
    {
      switch (this.InternalGetCorElementType())
      {
        ...
        case CorElementType.I:
          return ((IntPtr*) numPtr)->GetHashCode();
        case CorElementType.U:
          return ((UIntPtr*) numPtr)->GetHashCode();
        default:
          return 0;
      }
    }
  ...
  public bool HasFlag(Enum flag)
  {
    ...
    return this.GetType().IsEquivalentTo(flag.GetType()) ? this.InternalHasFlag(flag) : throw new ArgumentException(Environment.GetResourceString("Argument_EnumTypeDoesNotMatch", (object) flag.GetType(), (object) this.GetType()));
  }
  ...
  public static object ToObject(Type enumType, sbyte value)
  {
    if (enumType == (Type) null)
      throw new ArgumentNullException(nameof (enumType));
    RuntimeType enumType1 = enumType.IsEnum ? enumType as RuntimeType : throw new ArgumentException(Environment.GetResourceString("Arg_MustBeEnum"), nameof (enumType));
    return !(enumType1 == (RuntimeType) null) ? Enum.InternalBoxEnum(enumType1, (long) value) : throw new ArgumentException(Environment.GetResourceString("Arg_MustBeType"), nameof (enumType));
  }
  ...
  public static object ToObject(Type enumType, long value)
  {
    if (enumType == (Type) null)
      throw new ArgumentNullException(nameof (enumType));
    RuntimeType enumType1 = enumType.IsEnum ? enumType as RuntimeType : throw new ArgumentException(Environment.GetResourceString("Arg_MustBeEnum"), nameof (enumType));
    return !(enumType1 == (RuntimeType) null) ? Enum.InternalBoxEnum(enumType1, value) : throw new ArgumentException(Environment.GetResourceString("Arg_MustBeType"), nameof (enumType));
  }
  ...
  private static object ToObject(Type enumType, bool value)
  {
    if (enumType == (Type) null)
      throw new ArgumentNullException(nameof (enumType));
    RuntimeType enumType1 = enumType.IsEnum ? enumType as RuntimeType : throw new ArgumentException(Environment.GetResourceString("Arg_MustBeEnum"), nameof (enumType));
    return !(enumType1 == (RuntimeType) null) ? Enum.InternalBoxEnum(enumType1, value ? 1L : 0L) : throw new ArgumentException(Environment.GetResourceString("Arg_MustBeType"), nameof (enumType));
  }
