...
// MVID: 2465977A-A5D9-4EF7-9E53-4C4322881521
...
public static class Enumerable
{
  ...
  {
    return source != null ? Enumerable.DistinctIterator<TSource>(source, (IEqualityComparer<TSource>) null) : throw Error.ArgumentNull(nameof (source));
  }
  ...
  {
    return source != null ? Enumerable.ReverseIterator<TSource>(source) : throw Error.ArgumentNull(nameof (source));
  }
  ...
  {
    return source != null ? Enumerable.OfTypeIterator<TResult>(source) : throw Error.ArgumentNull(nameof (source));
  }
  ...
  {
    return count >= 0 ? Enumerable.RepeatIterator<TResult>(element, count) : throw Error.ArgumentOutOfRange(nameof (count));
  }
    ...
    foreach (float? nullable2 in source)
    {
      if (nullable2.HasValue)
      {
        if (nullable1.HasValue)
        {
          ...
          if (!((double) nullable3.GetValueOrDefault() < (double) nullable4.GetValueOrDefault() & nullable3.HasValue & nullable4.HasValue) && !float.IsNaN(nullable2.Value))
            continue;
        }
        nullable1 = nullable2;
      }
    ...
    foreach (double? nullable2 in source)
    {
      if (nullable2.HasValue)
      {
        if (nullable1.HasValue)
        {
          double? nullable3 = nullable2;
          double? nullable4 = nullable1;
          if (!(nullable3.GetValueOrDefault() > nullable4.GetValueOrDefault() & nullable3.HasValue & nullable4.HasValue) && !double.IsNaN(nullable1.Value))
            continue;
        }
        nullable1 = nullable2;
      }
  ...
  public static float Max(this IEnumerable<float> source)
  {
    ...
    foreach (float num in source)
    {
      if (flag)
      {
        if ((double) num > (double) d || double.IsNaN((double) d))
          d = num;
      }
      else
      {
    ...
    foreach (float? nullable2 in source)
    {
      if (nullable2.HasValue)
      {
        if (nullable1.HasValue)
        {
          float? nullable3 = nullable2;
          float? nullable4 = nullable1;
          if (!((double) nullable3.GetValueOrDefault() > (double) nullable4.GetValueOrDefault() & nullable3.HasValue & nullable4.HasValue) && !float.IsNaN(nullable1.Value))
            continue;
        }
        nullable1 = nullable2;
      }
    ...
    IEnumerator
  {
    ...
    public IEnumerator<TSource> GetEnumerator()
    {
      ...
      Enumerable.Iterator<TSource> enumerator = this.Clone();
      enumerator.state = 1;
      return (IEnumerator<TSource>) enumerator;
    }
    ...
    IEnumerable
  {
    ...
    public List<TResult> ToList()
    {
      ...
      foreach (TSource source in this._source)
        list.Add(this._selector(source));
      return list;
    }
  ...
  private class AppendPrependN<TSource> : Enumerable.AppendPrependIterator<TSource>
  {
    ...
    public override TSource[] ToArray()
    {
      ...
      if (this._source is ICollection<TSource> source1)
      {
