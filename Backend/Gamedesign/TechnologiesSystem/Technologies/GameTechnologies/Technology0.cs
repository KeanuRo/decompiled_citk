...
// Type: Backend.Gamedesign.TechnologiesSystem.Technologies.GameTechnologies.Technology0
...
[Technology(ScienceTree.Computers)]
public class Technology0 : AbstractTechnology
{
  ...
  private readonly ScienceCost[] subTechnologiesCosts = new ScienceCost[10]
  {
    ...
    {
      civilPoints = 250,
      cyberneticPoints = 250
    },
    new ScienceCost()
    {
      physicPoints = 400,
      civilPoints = 400,
      cyberneticPoints = 800
    },
    new ScienceCost()
    {
      physicPoints = 625,
